...
import 'package:intrasense/model/teams/EmployeesListModel.dart';
            ...
            child: CustomElevatedButton(
              onPressed: () {
                if (_groupNameController.text.isEmpty) {
                  ...
                  teamViewModel.addGroupApi(data, context);
                }
              },
  ...
  void updateSelectedEmployeeIds() {
    ...
    for (var selectedName in selectedEmployeeNames) {
      var employee = employeesList.firstWhere(
            (employee) => "${employee.userFirstName} ${employee.userLastName}" == selectedName,
        orElse: () => EmployeesListModel.empty(), // Return an empty object if no match is found
      );
